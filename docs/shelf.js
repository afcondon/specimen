...
(() => {
  ...
  var map10 = /* @__PURE__ */ map(functorCoyoneda);
  ...
  var evalQ = function(render3) {
    return function(ref2) {
      return function(q2) {
        return bind12(liftEffect4(read(ref2)))(function(v) {
          return evalM(render3)(ref2)(v["component"]["eval"](new Query(map10(Just.create)(liftCoyoneda(q2)), $$const(Nothing.value))));
        });
      };
    };
  };
      ...
      return function(i2) {
            ...
            return function(childrenInRef) {
              return function(childrenOutRef) {
                return unComponentSlot(function(slot3) {
                  return function __do2() {
                    var childrenIn = map11(slot3.pop)(read(childrenInRef))();
                    var $$var2 = (function() {
                    ...
                    var isDuplicate = map11(function($69) {
        ...
        var render3 = function(lchs) {
          return function($$var2) {
            return function __do2() {
              var v = read($$var2)();
              var shouldProcessHandlers = map11(isNothing)(read(v.pendingHandlers))();
  ...
  var runUI2 = function(component3) {
    return function(i2) {
      return function(element3) {
        return bind14(liftEffect6(map15(toDocument)(bindFlipped7(document2)(windowImpl))))(function(document3) {
  ...
  var Selected = /* @__PURE__ */ (function() {
    function Selected2(value0) {
      this.value0 = value0;
    }
    ;
    Selected2.create = function(value0) {
      return new Selected2(value0);
    };
    return Selected2;
  })();
  ...
  var paint = function(v) {
    return function(v1) {
      if (v instanceof Just && v1) {
        return "background:" + (v.value0 + ";color:#fff;font-weight:600");
      }
      ;
      if (v instanceof Just && !v1) {
        return "background:transparent;color:" + (v.value0 + ";font-weight:500");
      }
      ;
      if (v instanceof Nothing && v1) {
        return "background:" + (surface + (";color:" + (ink + ";font-weight:600")));
      }
      ;
      if (v instanceof Nothing && !v1) {
  ...
  var segBtn = function(input3) {
    return function(seg) {
      var active = seg.key === input3.active;
      return button([cls("hg-segmented__seg" + (function() {
        if (active) {
          return " is-active";
        }
        ;
        ...
        return new Pick(seg.key);
      }), sty("padding:5px 12px;border:0;border-left:1px solid " + (line + (";font-size:12px;" + ((function() {
        if (input3.disabled) {
          return "cursor:default;";
        }
        ;
        return "cursor:pointer;";
      })() + paint(seg.color)(active)))))])([text5(seg.label)]);
    };
  };
  var render = function(v) {
    return div2([cls("hg-segmented"), sty("display:inline-flex;border:1px solid " + (line + (";border-radius:var(--hw-radius,7px);overflow:hidden;" + ("font-family:" + (uiFont + (";" + (function() {
      ...
      var $38 = $$null(v.input.segments);
      if ($38) {
        return [];
      }
      ;
      return map16(segBtn(v.input))(v.input.segments);
    })());
  };
  var handleQuery = function(dictMonadAff) {
    return function(v) {
      return bind5(get2)(function(v1) {
        return discard4(when4(!v1.input.disabled && v.value0 !== v1.input.active)(raise(new Selected(v.value0))))(function() {
  ...
  var handleAction = function(dictMonadAff) {
    return function(v) {
      ...
      if (v instanceof Pick) {
        return bind5(get2)(function(v1) {
          return when4(!v1.input.disabled && v.value0 !== v1.input.active)(raise(new Selected(v.value0)));
        });
      }
      ;
  ...
  // output/Specimen.Shelf.Page/foreign.js
  var SECTIONS = "[data-shelf]";
  var readShelves = () => {
  ...
  var showOnly = (key) => () => {
    for (const section2 of document.querySelectorAll(SECTIONS)) {
      section2.hidden = section2.dataset.shelf !== key;
    }
  };

  // output/Specimen.Shelf.Main/index.js
    ...
    return function(v) {
      if (v instanceof Initialize2) {
        return bind6(gets2(function(v1) {
          ...
          return liftEffect7(showOnly($52));
        });
      }
      ;
      if (v instanceof Select) {
        return discard5(modify_4(function(v1) {
          ...
          return liftEffect7(showOnly(v.value0));
        });
      }
      ;
      throw new Error("Failed pattern match at Specimen.Shelf.Main (line 91, column 16 - line 95, column 30): " + [v.constructor.name]);
    };
  };
  var _segmented = /* @__PURE__ */ (function() {
    return $$Proxy.value;
  })();
    ...
    return function(v) {
      var tab = function(s) {
        return {
          key: s.key,
          label: s.label,
          color: new Just(s.color)
        };
      };
      return slot2(_segmented)(unit)(component22)((function() {
        var v1 = defaultInput(map17(tab)(v.shelves));
        return {
  ...
  var main2 = /* @__PURE__ */ runHalogenAff(/* @__PURE__ */ bind15(/* @__PURE__ */ liftEffect(monadEffectAff)(readShelves))(function(shelves) {
    return bind15(selectElement(mountPoint))(function(container) {
      var v = head(shelves);
      if (container instanceof Just && v instanceof Just) {
        return $$void7(runUI2(component1)({
          shelves,
          initial: v.value0.key
        })(container.value0));
      }
      ;
      return pure10(unit);
